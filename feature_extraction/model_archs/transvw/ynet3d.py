"""
Code copied and adapted from https://github.com/fhaghighi/TransVW/blob/master/pytorch/models/ynet3d.py
"""
...
class UNet3D_encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        return [self.out64,self.out128,self.out256,self.out512]
